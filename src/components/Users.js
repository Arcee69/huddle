...
function Users() {
  return (
    <div className='card row d-flex flex-row justify-content-between mt-5 shadow'>
                          {/* For Mobile Phones */}
      <img src={user} alt="grow-together" className='col-12 d-sm-none' style={{width:"40%", height:'50%', margin:'0 auto'}}/>
      ...
      <img src={user} alt="grow-together" className='hidden-xs' style={{width:"40%", height:'50%', margin:'3%'}}/>
    </div>
  )
}
