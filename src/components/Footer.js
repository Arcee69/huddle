        ...
        <div className="row d-flex justify-content-around">
          <div className="w-100 mtx">
            ...
            <div className="w-30 d-flex mt-4 col-12">
              ...
              <span className="ml-2 fs">+1-543-123-4567</span>
            </div>
            <div className="w-30 d-flex col-12">
              <img src={Email} alt="email" className="obj-1" />
              <span className="ml-2 fs">example@fylo.com</span>
            </div>
          </div>
          <div className="d-flex flex-column justify-content-between w-100">
            <ul className="col-12 mtx">
              ...
              <li>
                <a href="true">What We Do </a>
              </li>
              <li>
                <a href="true">FAQ</a>
              </li>
              <li>
                <a href="true">Career</a>
              </li>
              <li>
                <a href="true">Blog</a>
              </li>
          ...
          <div className="row w-100 mt-2 mb-3">
            ...
            <div className="px mgx-1">
              &copy; Copyright 2018 Huddle.All right reserved
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="d-flex justify-content-around">
          <div className="mr w-50">
            ...
            <div className="w-30 d-flex mt-4">
              <img src={Phone} alt="phone" className="obj" />
              <span className="ml-3 fs">+1-543-123-4567</span>
            </div>
            <div className="w-30 d-flex">
              <img src={Email} alt="email" className="obj-1" />
              <span className="ml-3 fs">example@huddle.com</span>
            </div>
          </div>
